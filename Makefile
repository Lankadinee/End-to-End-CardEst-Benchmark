...
all: execute_permission apply_patch docker init
...
run_experiment: docker init reset_logs test_experiment show_logs
...
copy_estimations:
	...
	@for file in workloads/$(DATABASE_NAME)/estimates/*.*; do \
		echo "Copying $$file"; \
