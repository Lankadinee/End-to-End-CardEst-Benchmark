...
# docker cp single_table_datasets/${DATABASE_NAME} $CONTAINER_ID:/tmp/single_table_datasets
# docker cp scripts $CONTAINER_ID:/tmp/scripts
# echo "Copied single_table_datasets and scripts to $CONTAINER_ID"
...
echo "Created database $DATABASE_NAME in $CONTAINER_ID"
